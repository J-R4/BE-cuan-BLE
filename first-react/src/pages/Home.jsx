        ...
        <div className="grid h-4/5 grid-cols-2 gap-4">
          ...
          <div>
            <div className="border-0 shadow-xl h-1/2">
              <Link to="/watch">
                <button className="py-0 px-1 font-small rounded-lg shadow-md text-white bg-yellow-600 hover:bg-yellow-700 transform hover:scale-110 motion-reduce:transform-none">
                  WatchList
                </button>
            ...
            <div className="border-0 shadow-xl h-1/2 hover:scale-110 motion-reduce:transform-none">
              <Link to="/stock">
                <button className="py-0 px-1 font-small rounded-lg shadow-md text-white bg-yellow-600 hover:bg-yellow-700 transform hover:scale-110 motion-reduce:transform-none">
                  Stocklist
                </button>
